...
class SlangDictionary:
    ...
    def __init__(self):
        ...
        self._cache.update({
            ...
            "crash": SlangInfo("crash", "sleep", "Sleep somewhere temporarily", "dormir / passar a noite", "informal", "universal", "social", []),
            ...
            "cracked": SlangInfo("cracked", "very skilled", "Extremely skilled or talented", "muito habilidoso / muito bom", "slang", "universal", "skill", []),
            "cracked at": SlangInfo("cracked at", "very skilled at", "Extremely skilled at something", "muito bom em / muito habilidoso em", "slang", "universal", "skill", []),
            "plug for": SlangInfo("plug for", "source for", "A person who can provide access to something", "contato para / fonte de", "slang", "universal", "social", []),
            "loaded": SlangInfo("loaded", "rich", "Very rich or wealthy", "rico / cheio de dinheiro", "informal", "universal", "money", []),
            "broke": SlangInfo("broke", "out of money", "Having no money", "sem dinheiro / duro", "informal", "universal", "money", []),
            "owned": SlangInfo("owned", "defeated", "Defeated or embarrassed decisively", "foi derrotado / foi humilhado", "slang", "universal", "competition", []),
            "juice": SlangInfo("juice", "influence", "Influence, power, or credibility", "influencia / relevancia", "slang", "universal", "status", []),
            "sauce": SlangInfo("sauce", "style", "Style, confidence, or charisma", "estilo / charme", "slang", "universal", "fashion", []),
            "grind": SlangInfo("grind", "hard work", "Hard work, hustle, or steady effort", "esforco / correria", "informal", "universal", "work", []),
            "blue": SlangInfo("blue", "sad", "Sad or down", "triste / para baixo", "informal", "universal", "emotion", []),
            "cheddar": SlangInfo("cheddar", "money", "Money", "dinheiro / grana", "slang", "universal", "money", []),
            "bucks": SlangInfo("bucks", "dollars", "Dollars", "dolares", "informal", "US", "money", []),
            "whip": SlangInfo("whip", "car", "A car", "carro", "slang", "US", "transport", []),
            "bounce": SlangInfo("bounce", "leave", "Leave", "ir embora / sair", "slang", "universal", "movement", []),
            "roll": SlangInfo("roll", "leave", "Leave or get going", "ir embora / partir", "slang", "universal", "movement", []),
            "clutch": SlangInfo("clutch", "very helpful", "Very helpful or important at the right moment", "decisivo / salvador", "slang", "universal", "praise", []),
            "ship": SlangInfo("ship", "want as a couple", "Want two people or characters to be in a romantic relationship", "torcer pelo casal", "slang", "fandom", "relationships", []),
            "i ship the two main characters": SlangInfo("i ship the two main characters", "i want the two main characters to be a couple", "Want two characters to be in a romantic relationship", "torço para os dois personagens principais ficarem juntos", "slang", "fandom", "relationships", []),
            "shade": SlangInfo("shade", "subtle insult", "A subtle insult or criticism", "indireta / critica sutil", "slang", "universal", "social", []),
            "pure shade": SlangInfo("pure shade", "a subtle insult", "A clear subtle insult or criticism", "uma indireta / uma critica sutil", "slang", "universal", "social", []),
            "beat": SlangInfo("beat", "exhausted", "Very tired", "exausto / acabado", "informal", "universal", "state", []),
            "fresh": SlangInfo("fresh", "stylish", "Stylish, clean, or good-looking", "estiloso / moderno", "informal", "universal", "fashion", []),
            "sharp": SlangInfo("sharp", "stylish", "Stylish, polished, or smart-looking", "elegante / bem arrumado", "informal", "universal", "fashion", []),
            "tight": SlangInfo("tight", "close", "Close as friends or emotionally connected", "proximo / muito amigo", "informal", "universal", "relationships", []),
            "the bomb": SlangInfo("the bomb", "excellent", "Excellent or very good", "excelente / muito bom", "slang", "universal", "praise", []),
            "let him cook": SlangInfo("let him cook", "let him keep going", "Let someone continue because their idea may work", "deixa ele continuar / deixa ele desenvolver", "slang", "universal", "encouragement", []),
            "let her cook": SlangInfo("let her cook", "let her keep going", "Let someone continue because their idea may work", "deixa ela continuar / deixa ela desenvolver", "slang", "universal", "encouragement", []),
            "go off": SlangInfo("go off", "keep going", "An encouragement to express yourself or perform confidently", "manda ver / arrasa", "slang", "universal", "encouragement", []),
        })
        self._loaded = False
